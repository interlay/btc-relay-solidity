...
interface SPVInterface extends Interface {
  functions: {
    ...
    verifyTx: TypedFunctionDescription<{
      encode([_header, _proof, _index, _txid, _confirmations]: [
        Arrayish,
        Arrayish,
        BigNumberish,
        Arrayish,
  ...
  events: {
    ...
    VerifyTransaction: TypedEventDescription<{
      encodeTopics([_txId]: [Arrayish | null]): string[];
    }>;
  };
}

export class SPV extends Contract {
  connect(signerOrProvider: Signer | Provider | string): SPV;
  attach(addressOrName: string): SPV;
  deployed(): Promise<SPV>;

  on(event: EventFilter | string, listener: Listener): SPV;
  once(event: EventFilter | string, listener: Listener): SPV;
  addListener(eventName: EventFilter | string, listener: Listener): SPV;
  removeAllListeners(eventName: EventFilter | string): SPV;
  removeListener(eventName: any, listener: Listener): SPV;
  ...
  filters: {
    ...
    VerifyTransaction(_txId: Arrayish | null): EventFilter;
  };
